    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-brand-dark">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold">{a.loginTitle}</h1>
          <p className="text-white/50 mt-2">{a.loginSub}</p>
        </div>
        ...
        <div className="card space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full mt-2">
              {loading ? a.loginBtnLoading : a.loginBtn}
            </button>
          </form>
        </div>
        ...
        <p className="text-center text-white/50 text-sm mt-6">
          {a.noAccount}{" "}
          <Link href="/auth/register" className="text-brand-green hover:underline">{a.createAccount}</Link>
        </p>
